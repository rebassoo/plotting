...
for e in chain:
    ...
    if jet_veto and passesBoosted and DATA:
    ...
    if jet_veto and passesBoosted and passesPPS:
    ...
    ######################################################################
    if jet_veto and passesBoosted and passesPPS and not DATA:
    ...
    if jet_veto and passesBoosted and passesPPS and not DATA and pfcand_nextracks<5 and recoMWhad > 50 and recoMWhad < 140:
    ...
    if jet_pruning and jet_veto and passesBoosted and passesPPS:
    ...
    if jet_veto and passesBoosted and passesPPS and pfcand_nextracks >9:
    ...
    if jet_veto and passesBoosted and not passesPPS and pfcand_nextracks_noDRl<5:
    ...
    if jet_veto and passesBoosted and passesPPS and recoMWhad<50 and DATA:
    ...
    if jet_veto and passesBoosted and passesPPS and recoMWhad<50:
    ...
    if jet_veto and passesBoosted and recoMWhad < 50:
    ...
    if jet_veto and passesBoosted and recoMWhad > 50 and pfcand_nextracks>9:
    ...
    if jet_veto and passesBoosted and recoMWhad > 50 and not passesPPS:
        if pfcand_nextracks<5:
    ...
    if jet_veto and not (dphiWW>2.5 and recoMWW>500 and MET>40 and WLeptonicPt>200):
