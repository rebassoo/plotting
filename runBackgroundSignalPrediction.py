...
#Ycut=["Ycut"]
#Ycut=["noYcut"]
#signal_regions=["MultiRP","MultiPixel"]
signal_regions=["MultiRP"]
#makeplot(muon_directory,Ycut[1],"muon","template_5up",signal_regions[0],"2018")
#sys.exit()
for y in Ycut:
    for s in signal_regions:
        makeplot(muon_directory,y,"muon","template_5up",s,"2018",True)
        #sys.exit()
        #makeplot(electron_directory,y,"electron","template_5up",s,"2018",True)
