...
for cut in CutflowHistoList:
    ...
    for sample in MCsamples:
        ...
        if "ExclusiveWW_" in sample:
            exclWWa02p5[i]=integral+exclWWa02p5[i]
            exclWWa02p5_error[i]=m.sqrt(exclWWa02p5_error[i]*exclWWa02p5_error[i]+error*error)            
        it=it+1
    ...
    QCD[i]=round(QCD[i],1)
    exclWWa02p5[i]=round(exclWWa02p5[i],1)
    ...
    exclWWa02p5_error[i]=round(exclWWa02p5_error[i],1)
