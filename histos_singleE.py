...
h_electron_pt=TH1F("h_electron_pt",";p_{T} (#e) [GeV];",100,0,1000)
h_electron_eta=TH1F("h_electron_eta",";#eta_{#e};",60,-3,3)
h_jet_pt=TH1F("h_jet_pt",";p_{T} (jet) [GeV];",100,0,1000)
...
h_electron_pt_jetVeto=TH1F("h_electron_pt_jetVeto",";p_{T} (#e) [GeV];",100,0,1000)
h_electron_eta_jetVeto=TH1F("h_electron_eta_jetVeto",";#eta_{#e};",60,-3,3)
h_jet_pt_jetVeto=TH1F("h_jet_pt_jetVeto",";p_{T} (jet) [GeV];",100,0,1000)
...
h_electron_pt_jet_pruned=TH1F("h_electron_pt_jetpruned",";p_{T} (#mu) [GeV];",100,0,1000)
h_electron_eta_jetpruned=TH1F("h_electron_eta_jetpruned",";#eta_{#mu};",60,-3,3)
h_jet_pt_jetpruned=TH1F("h_jet_pt_jetpruned",";p_{T} (#mu) [GeV];",100,0,1000)
...
for e in chain:
    ...
    #deltaR_lepton_jet=m.sqrt( (e.jet_phi[0]-e.electron_phi[0])*(e.jet_phi[0]-e.electron_phi[0]) + (e.jet_eta[0]-e.electron_eta[0])*(e.jet_eta[0]-e.electron_eta[0]) )
    #deltaPhi_jet_lepton=GetDphi(e.jet_phi[0],e.electron_phi[0])
    #met_phi=
    #deltaPhi_jet_MET=GetDphi(e.jet_phi[0],met_phi)
    #if deltaR_lepton_jet < 2.0 or deltaPhi_jet_lepton < 2.0:
    #    continue

    #h_mcWeight.Fill(e.mcWeight)
    h_electron_pt.Fill(e.electron_pt[0],pileupw)
    h_electron_eta.Fill(e.electron_eta[0],pileupw)
    ...
    if e.num_jets_ak4<1 and e.num_bjets_ak8 < 1:
        jet_veto=True
        h_electron_pt_jetVeto.Fill(e.electron_pt[0],pileupw)
        h_electron_eta_jetVeto.Fill(e.electron_eta[0],pileupw)
    ...
    if jet_pruning and jet_veto:
        h_electron_pt_jetpruned.Fill(e.electron_pt[0],pileupw)
        h_electron_eta_jetpruned.Fill(e.electron_eta[0],pileupw)
