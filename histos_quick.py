...
if not DATA and (sample_name != "ExclusiveWW"):
    modifyJson(sample_name,num_events)
...
for e in chain:
    ...
    if e.num_bjets_ak4<1 and passesBoosted and MET > METCUT:
    ...
    if e.num_bjets_ak4<1 and passesBoosted and MET > METCUT and ( (DATA and pfcand_nextracks >4) or not DATA):
