...
DATA=False
ExclusiveMC=False
if sample_name == "SingleElectron":    DATA=True
...
h_electron_pt=TH1F("h_electron_pt",";p_{T} (#mu) [GeV];",100,0,1000)
h_electron_eta=TH1F("h_electron_eta",";#eta_{#mu};",60,-3,3)
h_electron_iso=TH1F("h_electron_iso",";pf-based isolation {#mu};",20,0,0.2)
...
h_electron_pt_MjetVeto_WleptonicCuts=TH1F("h_electron_pt_MjetVeto_WleptonicCuts",";p_{T} (#mu) [GeV];",100,0,1000)
h_electron_eta_MjetVeto_WleptonicCuts=TH1F("h_electron_eta_MjetVeto_WleptonicCuts",";#eta_{#mu};",60,-3,3)
...
for e in chain:
    ...
    dphi_lepton_jet=GetDphi(e.electron_phi[0],e.jet_phi[0])
    deta_lepton_jet=e.electron_eta[0]-e.jet_eta[0]
